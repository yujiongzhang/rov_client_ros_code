...
bool rov_interfaces__msg__motor_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rov_interfaces.msg._motor_control.MotorControl", full_classname_dest, 46) == 0);
  }
  rov_interfaces__msg__MotorControl * ros_message = _ros_message;
  {  // thruster_speed
    PyObject * field = PyObject_GetAttrString(_pymsg, "thruster_speed");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 6;
      int16_t * dest = ros_message->thruster_speed;
...
PyObject * rov_interfaces__msg__motor_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rov_interfaces.msg._motor_control");
  ...
  {  // thruster_speed
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "thruster_speed");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int16_t * src = &(ros_message->thruster_speed[0]);
